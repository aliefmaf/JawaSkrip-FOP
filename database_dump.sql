...
INSERT INTO public.loan (loan_id, user_id, principal_amount, annual_interest_rate, repayment_period, payment_per_period, total_repayment, start_date, end_date, loan_status, total_amount_paid) VALUES (1, 11, 10000.00, 5.00, 1, 856.07, 10272.90, '2025-01-05', '2026-01-05', 'Active', 1000.00);
...
INSERT INTO public.loan_repayment (repayment_id, loan_id, payment_amount, remaining_amount, payment_date) VALUES (9, 1, 1000.00, 9272.00, '2025-01-05 17:43:54');
...
SELECT pg_catalog.setval('public.loan_loan_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.loan_repayment_repayment_id_seq', 9, true);
